...
' Project: ADB File Explorer
' Author : Dean Barrow
' URL: deanbarrow.co.uk
...
Private Sub cmdRm_Click()
    ...
    MsgBox "Feature coming in v0.3"
    Exit Sub
    
'    'Delete file/dir in active pane
'    Dim Command As String
'
'    If ActivePane = "" Then
'        MsgBox "Please select an item first!"
'        Exit Sub
'    ElseIf ActivePane = "Drive" Then
'        Command = DrivePath & "\" & lstDrive.Text
'        If MsgBox("Are you sure you want to delete:" & vbCrLf & Command, vbYesNo, "Confirmation") = vbYes Then
'            DOS "del /Q " & Chr(34) & Command & Chr(34)
'            ListDrive DrivePath
'        End If
'    ElseIf ActivePane = "Device" Then
'        Command = DevicePath & "\" & lstDeviceDir.Text
'        If MsgBox("Are you sure you want to delete:" & vbCrLf & Command, vbYesNo, "Confirmation") = vbYes Then
'            ADB "shell busybox rm -rf " & Chr(34) & Command & Chr(34)
'            ListDevice DevicePath
'        End If
'    End If
...
Private Sub lstDeviceDir_DblClick()
    ...
    'If Left(Selection, 3) = " | " Then Selection = Right(Selection, Len(Selection) - 3)
...
Dim Command As String
Command = ADBPath & " shell busybox ls -1 -A -L -p " & Path
